...
const Subscription = () => {
  ...
  return (
    <div className="">
      ...
      <Separator />
      {addSubscription ? (
        <Form userData={user} setAddSubscription={setAddSubscription} />
      ) : (
        <div className="flex flex-col items-center justify-center !min-h-[calc(100vh-14rem)] py-10 space-y-3">
          ...
          <Button onClick={() => setAddSubscription(true)} variant="secondary">
            Add subscription
          </Button>
        </div>
      )}
...
const Form = ({ userData, setAddSubscription }) => {
